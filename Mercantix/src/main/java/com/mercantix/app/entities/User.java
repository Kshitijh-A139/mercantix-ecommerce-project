...
public class User {
	...
	public User(Integer userld, String username, String email, String password, Role role, LocalDateTime createdAt,
	...
	public String toString() {
		return "User [userld=" + userld + ", username=" + username + ", email=" + email + ", password=" + password
				+ ", role=" + role + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(createdAt, email, password, updatedAt, userld, username);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(createdAt, other.createdAt) && Objects.equals(email, other.email)
				...
				&& Objects.equals(userld, other.userld) && Objects.equals(username, other.username);
	}	
}
